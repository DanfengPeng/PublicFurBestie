...
// Initialize EmailJS (only once per site)
(function () {
    emailjs.init("h3_ERKdg3w5LyOYze"); // Replace with your EmailJS public key
})();
...
// Apply to all contact forms in the footer
document.addEventListener('DOMContentLoaded', function () {
    // Select all forms with id 'contact-footer-form' (in case you have more than one)
        ...
        form.addEventListener('submit', function (e) {
            ...
            emailjs.send('service_31yisxd', 'template_cqqt16p', {
                ...
                .then(function (response) {
                    ...
                    // Send email to yourself
                    emailjs.send('service_31yisxd', 'template_cqqt16p', {
                        to_email: 'dfpeng32@hotmail.com', // Replace with your email
                        firstName: firstName,
